...
def get_config(read_cfg=True):
    ...
    cfg['id'] = '10deg'
    cfg['hsv_ranges'] = {
        'red': [[165, 100, 30], [180, 255, 255]],
        'green': [[60, 100, 30], [78, 255, 255]],
        'blue': [[103, 100, 25], [120, 255, 255]],
    }
    ...
    # ])
    cfg["cam_intr"] = np.array([
        [601.67626953125, 0, 325.53509521484375],
        [0, 601.7260131835938, 248.60618591308594],
        [0, 0, 1 ]
    ])
    cfg['im_w'] = 640
    cfg['im_h'] = 480
